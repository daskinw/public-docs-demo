...
You can check which [integrations](../integrations/overview.md) are installed for your organization and [install new integrations](../snippets-and-insights/insights/install-an-integration.md) from this page.
