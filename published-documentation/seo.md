...
Moving your content to GitBook or changing its structure? Broken links can impact your SEO. [Read how to set up redirects in GitBook (via Git sync)](../snippets-and-insights/git-sync/content-configuration.md#redirects).
