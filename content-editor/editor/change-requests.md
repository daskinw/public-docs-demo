...
{% hint style="info" %}
**Note:** You’ll need to open a change request to edit any content in any [published](../../published-documentation/overview.md) space, any space that’s [synced with GitHub or GitLab](../../snippets-and-insights/git-sync/), or any space with [locked live edits](live-edits.md).
{% endhint %}
